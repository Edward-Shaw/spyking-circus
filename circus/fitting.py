    ...
    for gcount, gidx in enumerate(to_explore):
        ...
        if n_t > 0:
            ...
            while (numpy.mean(failure) < nb_chances):
                ...
                if full_gpu:
                    data        = sub_b * mask #b.mult(gpu_mask, data)
                ...
                for peak_index in argmax_bi:
                    ...
                    if full_gpu:
                        best_amp  = sub_b[best_template_index[0], peak_index[0]]/n_scalar
                        best_amp2 = b[best_template_index[0], peak_index[0]]/n_scalar
                        best_amp_n   = best_amp/norm_templates[best_template_index]
                        best_amp2_n  = best_amp2/norm_templates[best_template_index + n_tm]
